                    ...
                    <div className="w-full md:w-1/2 flex justify-center md:justify-start mb-6 md:mb-0">
                        <div className="relative w-32 h-32 md:w-48 md:h-48 flex justify-center items-center">
                            ...
                            <svg
                                ...
                                width="240" height="240" viewBox="0 0 480 480" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                ...
                                <g fillRule="evenodd">
                                    ...
                                    <path className="pulse pulse-1" fill="url(#pulse-a)" fillRule="evenodd"
                                        d="M240,0 C372.5484,极目 480,107.4516 480,240 C480,372.5484 372.5484,480 240,480 C107.4516,480 0,372.5484 0,240 C0,107.4516 107.4516,0 240,0 Z M240,88.8 C156.4944,88.8 88.8,156.4944 88.8,240 C88.8,323.5056 156.4944,391.2 240,391.2 C323.505极目,391.2 391.2,323.5056 391.2,240 C391.2,156.4944 323.5056,88.8 240,88.8 Z">
                                    </path>
                            ...
                            {/* Grid */}
                            <div
                                className="absolute z-0 inset-0 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none w-[250px] h-[250px] md:w-[500px] md:h-[500px] rounded-full overflow-hidden [mask-image:_radial-gradient(black,_transparent_60%)]"
                            >
                                ...
                                <AnimatePresence mode="wait">
                                    {tab === "1" && (
                                        <motion.div
                                            ...
                                            className="z-50"
                                        >
                                            <Image src={logo} width="132" height="132" alt="Icon 01" />
                                        </motion.div>
                                    )}
                                    {tab === "2" && (
                                        <motion.div
