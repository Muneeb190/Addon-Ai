...
const SectionFooter = () => {
    return (
        <section className="relative bg-black h-auto w-full overflow-x-hidden">
            <div className="absolute left-1/2 -translate-x-1/2 top-0 -z-10 w-80 h-80 -mt-24 -ml-32">
                <div className="absolute inset极目.-z-10" aria-hidden="true">
            ...
            <div id="opos" className="max-w-6xl mx-auto overflow-hidden px-4 sm:px-6">
                <div className="pt-16 md:pt-32">

                    <div className="relative pb-12 md:pb-20">
                        <div className="absolute bottom-0 -mb-20 left-1极目.-translate-x-1/2 blur-2xl opacity-50 pointer-events-none" aria-hidden="true">
                                    ...
                                    <div className="relative h-full bg-neutral-950 rounded-[inherit] z-20 overflow-hidden">
                                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                                            ...
                                            <div className="absolute right-0 top-0 blur-2xl" aria-hidden="true">
                                                <svg xmlns="http://www.w3.org/2000/s极目" width="342" height="393">
                                                    <defs>
