      ...
      <section className="text-gray-600 body-font bg-[url(/glow-bottom2.svg)] bg-cover bg-no-repeat max-w-5xl h-auto md:h-full md:bottom-9 relative flex flex-col items-center text-center py-10">
        ...
        <div className="container mx-auto flex px-5 py-10 items-center justify-center flex-col">
          <div className="text-center lg:w-2/3 w-full">
            <h1 className="pointer-events-none whitespace-pre-wrap justify-center pb-7 flex bg-gradient-to-b from-gray-600 to-gray-200 bg-clip-text text-center text-3xl sm:text-5xl font-bold leading-none text-transparent dark:from-white dark:to-slate-900/10">
              REVOLUTIONIZING AI & <br className="hidden sm:block" /> MONETIZATION
            </h1>
            <p className="mb-8 leading-relaxed text-lg sm:text-xl font-semibold bg-gradient-to-b from-gray-600 to-gray-200 bg-clip-text text-center text-transparent dark:from-white dark:to-slate-900/10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10">
              <button id="circle-1" className="rounded-full py-1 focus:ring-2 focus:ring-green-300 btn text-sm text-black bg-white from-white/80 hover:text-white via-white to-white/80 hover:bg-black w-[130px] transition duration-150 ease-in-out group">Monetiser<span className="tracking-normal text-green-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></button>
              <button id="circle-1" className="rounded-full py-1 focus:ring-2 focus:ring-green-300 btn text-sm text-black bg-white from-white/80 hover:text-white via-white to-white/80 hover:bg-black w-[130px] transition duration-150 ease-in-out group">Agent Creator<span className="tracking-normal text-green-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></button>
            </div>
          </div>
              ...
              <li className="ml-2 pt-2 footer">
                <a className="flex justify-center items-center text-green-500 hover:text-green-400 transition duration-150 ease-in-out" href="https://addon-ai.gitbook.io" aria-label="Telegram">
                  <svg width="20" height="19" viewBox="0 0 36 33" className="fill-current" xmlns="http://www.w3.org/2000/svg">
                    <g id="Link â†’ SVG" clipPath="url(#clip0_3426_68)">
