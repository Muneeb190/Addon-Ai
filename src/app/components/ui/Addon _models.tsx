...
export function Addon_models() {
    ...
    return (
        <div className="h-auto w-full pt-20 bg-black px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col py-9 justify-center items-center text-center">
                <h5 className="bg-gradient-to-b from-green-700 to-gray-200 bg-clip-text text-xl font-bold leading-none text-transparent dark:from-white dark:to-slate-900/10">Addon AI Models</h5>
                <h1 className="bg-gradient-to-b from-gray-700 pt-6 to-gray-200 bg-clip-text text-4xl sm:text-6xl font-bold leading-none text-transparent dark:from-white dark:to-slate-900/10">B2B Model</h1>
                <p className="bg-gradient-to-b from-green-700 pt-6 to-gray-200 bg-clip-text text-lg sm:text-xl font-bold leading-none text-transparent dark:from-white dark:to-slate-900/10">Monetizing AI Agents and Social Platforms</p>
            ...
            <div className="relative overflow-hidden py-10 sm:py-20 bg-black">
